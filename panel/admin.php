...
if ( isset($_GET['m']) ){
	switch($_GET['m']) {
		...
		/* clientes */
		case "folder":
			$paginaPHP = "php/folder.php";
		break;
		case "folders":
			$paginaPHP = "php/folders.php";
		break;
		case "foldersAgregar":
			$paginaPHP = "php/foldersAgregar.php";
		break;
		case "foldersEditar":
			$paginaPHP = "php/foldersEditar.php";
		break;
		case "clientes":
		...
		break;
			case "invoiceEditar":
			$paginaPHP = "php/invoiceEditar.php";
		break;
						...
						<section class="w-f scrollable">
							<div class="slim-scroll" data-height="auto" data-disable-fade-out="true" data-distance="0" data-size="5px" data-color="#333333">
								...
								<nav class="nav-primary hidden-xs">
									<ul class="nav">
										<li> <a href="admin.php?m=clientes"><i class="fa fa-angle-right icon"></i><span>Clientes</span> </a></li>
										<li> <a href="admin.php?m=folders"> <i class="fa fa-angle-right"></i> <span>Folders</span> </a> </li>
